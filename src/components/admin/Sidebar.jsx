...
const Sidebar = () => {
  ...
  return (
    <div className="w-full border-2 border-[#000] ">
      ...
      <div className="bg-[#DEE5F8] h-[78vh]  ">
        {sideBar.map((item) => (
          <div className="py-3 px-3">
            <Link key={item.path} to={item.path}>
              <div
                onClick={item.onclick}
                className={`flex items-center w-full gap-4 hover:bg-[#76A0EE] hover:text-white  px-3 py-3  max-lg:gap-1 ${
                  isActive(item) ? "bg-[#76A0EE] text-white " : ""
                }`}
              >
                <div className="text-3xl">{item.svg}</div>
                <div>
